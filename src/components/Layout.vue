...
import { Bars3Icon, EllipsisVerticalIcon, MagnifyingGlassIcon } from '@heroicons/vue/24/outline'
  ...
  <header
    ...
    <div class="max-w-[90rem] px-4 sm:px-6 md:px-8 mx-auto h-[3.3rem]">
      <div class="flex items-center h-[3.3rem] gap-4">
        <button type="button" class="md:hidden text-gray-600">
        ...
        <div class="ml-auto md:flex items-center md:divide-x md:divide-gray-200 md:dark:divide-gray-700">
          ...
          <div class="hidden md:flex md:items-center gap-6 pl-6">
            ...
            <a v-if="githubUrl" :href="githubUrl" class="text-gray-500 dark:text-gray-400">
              <svg class="w-5 fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div class="flex items-center gap-3 pl-6">
            <button type="button" class="md:hidden flex-shrink-0 text-gray-600">
